 ...
 */
public class TgSecurityLogoutSuccessHandler4fore extends SimpleUrlLogoutSuccessHandler implements LogoutSuccessHandler, InitializingBean {
    private final Logger log = LogManager.getLogger(TgSecurityLogoutSuccessHandler4fore.class);
    @Autowired
