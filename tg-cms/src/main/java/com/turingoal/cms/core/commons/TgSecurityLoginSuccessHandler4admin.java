 ...
 */
public class TgSecurityLoginSuccessHandler4admin extends SimpleUrlAuthenticationSuccessHandler implements InitializingBean {
    private final Logger log = LogManager.getLogger(TgSecurityLoginSuccessHandler4admin.class);
